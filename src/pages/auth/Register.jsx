  ...
  const submit = async (e) => {
    ...
    try {
      ...
      if (res.data?.ok) {
        ...
        setErr(res.data?.error?.message || "Registration failed");
      }
    } catch (err) {
      setErr(err.response?.data?.error?.message || err.message || "Registration failed");
    } finally {
      setIsLoading(false);
    }
  };
      ...
      <div className="max-w-md w-full bg-gradient-to-br from-gray-900 to-gray-800 rounded-2xl shadow-2xl overflow-hidden transition-all duration-300 hover:shadow-purple-500/10">
        <div className="py-6 px-8 relative">
          ...
          <div className="relative z-10">
            ...
            <p className="text-center text-gray-400 mt-2">Join us to begin your journey</p>
            ...
            <div className="mt-6">
              ...
              <div className="mt-4 text-center">
                <a href="/login" className="font-medium text-purple-400 hover:text-purple-300 transition-colors duration-200 inline-flex items-center">
