...
export default function Sessions() {
  ...
  const revokeSession = async (tokenId) => {
    ...
    try {
      await api.post("/auth/sessions/revoke", { tokenId });
        ...
        <div className="bg-gradient-to-br from-gray-900 to-gray-800 rounded-2xl shadow-2xl overflow-hidden transition-all duration-300 hover:shadow-purple-500/10">
          <div className="py-8 px-8 relative">
            ...
            <div className="relative z-10">
              <h1 className="text-3xl font-bold bg-gradient-to-r from-purple-400 to-rose-400 bg-clip-text text-transparent text-center mb-2">
                Active Sessions
              </h1>
                      ...
                      <div className="flex items-start justify-between">
                        <div className="flex items-start space-x-3">
                          ...
                          <div className="flex-1">
                            ...
                            <p className="text-sm text-gray-400 mt-1">{s.ua}</p>
