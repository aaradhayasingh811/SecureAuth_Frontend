        ...
        <div className="max-w-md w-full text-center">
          ...
          <div className="relative">
            ...
            <div className="relative z-10">
              {/* Icon */}
              <div className="inline-flex items-center justify-center w-24 h-24 rounded-full bg-rose-900/30 mb-8">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-12 w-12 text-rose-400" viewBox="0 0 20 20" fill="currentColor">
                  <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zM8.707 7.293a1 1 0 00-1.414 1.414L8.586 10l-1.293 1.293a1 1 0 101.414 1.414L10 11.414l1.293 1.293a1 1 0 001.414-1.414L11.414 10l1.293-1.293a1 1 0 00-1.414-1.414L10 8.586 8.707 7.293z" clipRule="evenodd" />
                </svg>
              </div>

              {/* Heading */}
              <h1 className="text-4xl font-bold bg-gradient-to-r from-rose-400 to-orange-400 bg-clip-text text-transparent mb-4">
                Access Denied
              </h1>
              ...
              <p className="text-gray-400 mb-6">
                You need to be logged in to view this page. Please authenticate to continue.
              </p>
              ...
              <div className="bg-gray-800/50 p-4 rounded-lg border border-gray-700">
                <h3 className="text-sm font-medium text-gray-300 mb-2 flex items-center justify-center">
                ...
                <ul className="text-xs text-gray-400 space-y-1 text-left">
                  ...
                  <li className="flex items-start">
                    <span className="text-rose-400 mr-2">•</span>
                    You need proper authentication credentials
                  </li>
                  <li className="flex items-start">
                    <span className="text-rose-400 mr-2">•</span>
